...
CREATE OR REPLACE FUNCTION public.get_all_comments(
    ...
    RETURNS TABLE(id integer, user_name character varying, rating integer, comment_text character varying, photo_data text, approved boolean, created_at timestamp with time zone)
    LANGUAGE 'plpgsql'
    COST 100
